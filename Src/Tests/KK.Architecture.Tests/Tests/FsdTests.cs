using KK.Architecture.Tests.Utils;

namespace KK.Architecture.Tests.Tests;

public class FsdTests
{
    public static TheoryData<string, Assembly> TestData = SolutionUtils.FrontendAssemblies;
