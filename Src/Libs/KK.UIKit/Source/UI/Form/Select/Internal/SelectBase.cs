...
public abstract class SelectBase<TItem, TValue> : ComponentBase, IAsyncDisposable
{
    ...
    private DotNetObjectReference<SelectBase<TItem, TValue>> DotNetObjRef { get; set; } = null!;
    ...
    internal protected abstract Task SetValue(TItem item, bool withClose = true);
    internal protected abstract bool IsItemSelected(TItem item);
